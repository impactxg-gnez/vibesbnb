    ...
    <div className="min-h-screen bg-charcoal-950 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full space-y-8">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  id="remember"
                  type="checkbox"
                  className="h-4 w-4 text-earth-600 focus:ring-earth-500 border-charcoal-700 rounded bg-charcoal-800"
                />
                <label htmlFor="remember" className="ml-2 block text-sm text-mist-300">
                  Remember me
                </label>
              </div>
              <Link href="/forgot-password" className="text-sm text-earth-500 hover:text-earth-400">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-mist-400">
          ...
          <Link href="/signup" className="font-medium text-earth-500 hover:text-earth-400">
            Sign up
          </Link>
        </p>
      </div>
