      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-3">
            <button
              onClick={() => {
                const profileUrl = `${window.location.origin}/host/${user?.id}`;
                ...
                >
                  ...
                  <div className="relative h-48 bg-gray-800">
                    ...
                    <button
                      ...
                      className="absolute bottom-3 right-3 p-2 bg-black/60 backdrop-blur-sm text-white rounded-full hover:bg-emerald-600 transition-colors z-20"
      ...
      {showGoogleLocationModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 border border-gray-800 rounded-xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Add Google Maps Location</h2>
            <p className="text-gray-400 mb-6">
              Paste Google Maps URLs for the selected properties. We'll extract the precise coordinates automatically.
            </p>

            <div className="bg-blue-900/20 border border-blue-600/50 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-300">
                <strong>Tip:</strong> Copy the Google Maps URL from the property's original listing page, or search for the address on Google Maps and copy the URL.
              </p>
            </div>

            <div className="space-y-4 mb-6">
              {propertiesForLocation.map((prop, index) => (
                <div key={prop.id} className="bg-gray-800 rounded-lg p-4">
                  ...
                  <input
                    ...
                    value={prop.url}
                    onChange={(e) => {
                      const updated = [...propertiesForLocation];
                      updated[index].url = e.target.value;
                      setPropertiesForLocation(updated);
                    }}
                    placeholder="https://www.google.com/maps/@25.7616798,-80.1917902,15z or https://maps.google.com/?q=25.7616798,-80.1917902"
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleGoogleLocationSubmit}
                disabled={updatingLocations || propertiesForLocation.every(p => !p.url.trim())}
