...
import { validateSignupPhone } from '@/lib/auth/phone';
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const phoneCheck = validateSignupPhone(formData.phone);
    if (!phoneCheck.ok) {
        ...
        <div className="bg-surface shadow-[0_30px_60px_rgba(0,0,0,0.5)] rounded-[2.5rem] p-10 border border-white/5 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted ml-1">
                Required for booking. We&apos;ll send a one-time SMS code to verify it after you confirm your email.
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="input !py-4 w-full pr-10"
                    placeholder="••••"
                    disabled={isLoading}
                  />
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-primary-500 transition-colors focus:outline-none"
