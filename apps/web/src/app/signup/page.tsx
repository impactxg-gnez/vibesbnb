        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent dark:bg-gray-700 dark:text-white"
              >
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 mt-1 text-green-600 focus:ring-green-600 border-gray-300 rounded"
              />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
