        ...
        <div className="bg-gray-900 shadow-lg rounded-xl p-8 border border-gray-800">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-700 bg-gray-800 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-white"
              >
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 mt-1 text-emerald-600 focus:ring-emerald-500 border-gray-700 rounded bg-gray-800"
              />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-700 rounded-lg hover:bg-gray-800 transition">
