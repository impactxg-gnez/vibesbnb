...
export function WhyUs() {
  return (
    <div className="container mx-auto px-4 sm:px-6 pb-28 sm:pb-32">
      <div className="bg-surface relative overflow-hidden rounded-3xl sm:rounded-[3rem] p-6 sm:p-10 md:p-12 border border-white/5">
