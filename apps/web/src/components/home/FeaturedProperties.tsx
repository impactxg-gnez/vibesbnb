                ...
                {properties.map((property, index) => (
                    ...
                    >
                        <Link href={`/listings/${property.id}`} className="group block h-full">
                            ...
                            <div
                              className={`rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] group-hover:-translate-y-2 h-full flex flex-col relative ${
                                vibeMarker
